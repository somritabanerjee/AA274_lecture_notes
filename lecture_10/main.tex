...
Topics covered: Behavioral and map-based localization, belief representation, random variable, joint probability, conditional probability, theorem of total probability, Bayes' rule, expectation, covariance, Bayes' filter.
